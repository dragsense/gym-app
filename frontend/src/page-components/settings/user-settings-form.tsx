...
interface IUserSettingsFormHandlerProps extends THandlerComponentProps<TSingleHandlerStore<IUserSettings, any>> {
...
export default function UserSettingsFormHandler({
    ...
    const { response, isLoading } = store(useShallow(state => ({
    ...
    const INITIAL_VALUES: TUserSettingsData = {
        ...
        limits: {
            ...
            maxClientsPerTrainer: undefined,
            sessionDurationDefault: undefined,
        },
        business: {
    ...
    const initialValues = strictDeepMerge<TUserSettingsData>(INITIAL_VALUES, response ?? {});
