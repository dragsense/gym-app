        ...
        <PageInnerLayout Header={<Header />}>
            <SingleHandler<ISession, any>
                ...
                initialParams={{ 
                    ...
                    _select: 'trainer.id, trainer.user.email, trainer.user.profile.firstName, trainer.user.profile.lastName,  clients.user.email, clients.user.profile.firstName, clients.user.profile.lastName',
