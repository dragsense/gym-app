...
const clientService = new BaseService<
  IClient,
  TClientData,
  Partial<TClientData>
>(CLIENTS_API_PATH);
...
export const fetchClients = (params: IListQueryParams) =>
  clientService.get(params);
export const fetchClient = (id: string, params: IListQueryParams) =>
  clientService.getSingle(id, params);
export const createClient = (data: TClientData) => clientService.post(data);
export const updateClient = (id: string) => clientService.patch(id);
