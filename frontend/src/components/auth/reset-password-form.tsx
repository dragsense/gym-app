  ...
  return (
    ...
    >
      <AppCard
        header={
          <>
            <h2 className="text-md font-semibold">{buildSentence(t, 'reset', 'password')}</h2>
            <p className="text-sm text-muted-foreground">{buildSentence(t, 'enter', 'your', 'new', 'password', 'to', 'reset', 'your', 'account')}</p>
          </>
        }
        footer={
