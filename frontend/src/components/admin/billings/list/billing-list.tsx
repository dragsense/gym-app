...
interface IBillingListProps extends TListHandlerComponentProps<TListHandlerStore<IBilling, TBillingListData, IBillingListExtraProps>,
  TSingleHandlerStore<IBilling, TBillingViewExtraProps>> {
}
