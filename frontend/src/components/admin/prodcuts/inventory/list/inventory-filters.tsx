...
interface IInventoryFiltersProps {
  store: TListHandlerStore<IInventory, TInventoryListData, any>;
}

export function InventoryFilters({
  store,
}: IInventoryFiltersProps) {
  ...
  const inputs = useInput<TInventoryListData>({
    fields: filteredFields as TFieldConfigObject<TInventoryListData>,
  });
