...
interface IUserFormProps extends THandlerComponentProps<TFormHandlerStore<TUserData, TUserResponse>> {
}
  ...
  return <>
    <div data-component-id={componentId} className="space-y-6">
      ...
      <AppCard header={<>
        ...
        <p className="text-sm text-muted-foreground">Update your user information</p>
      </>}
        footer={
