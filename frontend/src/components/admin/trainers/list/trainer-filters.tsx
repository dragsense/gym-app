...
interface ITrainerFiltersProps {
  store: TListHandlerStore<ITrainer, TTrainerListData, any>;
}

export function TrainerFilters({
  store,
}: ITrainerFiltersProps) {
  ...
  const inputs = useInput<TTrainerListData>({
    fields: filteredFields as TFieldConfigObject<TTrainerListData>,
  });
