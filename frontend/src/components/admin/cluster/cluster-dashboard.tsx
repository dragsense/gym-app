...
export const ClusterDashboard = ({
  ...
  // React 19: Memoized error state for better performance
  ...
  // React 19: Smooth refresh action
  const handleRefresh = () => {
    startTransition(() => {
      onRefresh();
    });
  ...
  return (
    <div className="space-y-6" data-component-id={componentId}>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleRefresh} variant="outline" size="sm" data-component-id={componentId}>
          <RefreshCw className="h-4 w-4 mr-2" />
          Refresh
        </Button>
      </div>
