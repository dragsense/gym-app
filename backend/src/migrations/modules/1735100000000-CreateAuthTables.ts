...
export class CreateAuthTables1735100000000 implements MigrationInterface {
  name = 'CreateAuthTables1735100000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropIndex('auth_otp_codes', 'IDX_auth_otp_codes_deviceId');
