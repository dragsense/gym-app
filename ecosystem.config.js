module.exports = {
  ...
  deploy: {
    prod: {
      ...
      "pre-setup": "rm -rf /var/www/trainer_usr/data/www/trainer.digital.st/prod/source || true",
    ...
    dev: {
      ...
      key: "C:/Users/ranaa/.ssh/trainer-server",
      "pre-setup": "rm -rf /var/www/trainer_usr/data/www/trainer.digital.st/dev/source || true",
      "post-setup": "touch ../shared/.env ../shared/.env ../shared/.env.prod",
      "post-deploy": "sh ./deploy.sh",
    },
  },
