...
export class PaymentMethodsController {
  ...
  @ApiOperation({ summary: 'Get all payment methods with pagination and filtering' })
  @ApiResponse({
    status: 200,
  ...
  update(
    ...
    return this.paymentMethodsService.updatePaymentMethod(id, updatePaymentMethodDto);
  }
